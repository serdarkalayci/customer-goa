...
import (
	...
	"github.com/gostore/src/customer/client"
	"github.com/gostore/src/customer/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "customer-cli",
		Short: `CLI client for the customer service`,
	}
	...
	app.PersistentFlags().StringVarP(&c.Host, "host", "H", "localhost:6543", "API hostname")
